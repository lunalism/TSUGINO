...
| Item | Status |
|---|---|
| Station facility / layout data (GTFS-Pathways for Toei; images/station maps for Yurikamome, TWR) | VERIFIED_CATALOG (presence); Toei GTFS-Pathways is catalog-labelled contest-period-limited publication — not stable production coverage (§3.5.4, RK-17) |
